...
saveToPhoenix_thread = threading.Thread(target=saveToPhoenix,args=(consumer,))
keepconn_thread = threading.Thread(target=keepconn,args=(cursor,))
saveToPhoenix_thread.start()
keepconn_thread.start()
saveToPhoenix_thread.join()
